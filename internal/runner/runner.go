...
type Config struct {
	...
	EnvironmentVars                    map[string]map[string]string // vars keyed by deployment environment name
	StepSummaryFile                    string                       // optional host path for aggregated step summaries
}
