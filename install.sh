#!/bin/sh
set -e
# Code originally generated by godownloader; maintained manually in this repo.
# godownloader is deprecated — do not regenerate with GO111MODULE=off.
#
